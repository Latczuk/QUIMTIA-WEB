...
export const Products: products[] = [
  {
    ...
    features: ["Possui um prazo de validade (06 meses)", "Alimentação de camundongos e ratos de laboratório"],
  ...
  },
  {
    ...
    description:
      "Ração formulada para camundongos e ratos de laboratório que pode ser autoclavável, o que a torna ideal para ambientes de laboratório que exigem esterilização rigorosa.",
    features: ["Possui um prazo de validade (06 meses)", "Alimentação de camundongos e ratos de laboratório"],
    species: "Ratos e Camundongos",
  ...
  },
  {
    ...
    description:
      "Ração irradiada, formulada para camundongos e ratos de laboratório, ideal para ambientes que exigem biossegurança e esterilização",
    features: ["Possui um prazo de validade estendido (12 meses)", "Alimentação de camundongos e ratos de laboratório"],
    species: "Ratos e Camundongos",
  ...
  },
  {
    ...
    description:
      "Ração pronta para uso, irradiada, com formulação específica para camundongos e ratos de laboratório em reprodução, com foco em fêmeas em gestação e lactação, e animais jovens",
    features: [
      "Possui um prazo de validade estendido (12 meses)",
      "Alimentação de camundongos e ratos de laboratório em reprodução, principalmente fêmeas em gestação e lactação e animais jovens (até 80% do peso adulto)",
    ],
    species: "Ratos e Camundongos",
